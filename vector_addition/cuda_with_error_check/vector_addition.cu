...
int main()
{
    ...
    // Check for synchronous errors during kernel launch
    // (e.g. invalid execution configuration paramters)
    gpuErrorCheck( cudaGetLastError() );

    // Check for asynchronous errors during GPU execution
    // (after control is returned to CPU)
